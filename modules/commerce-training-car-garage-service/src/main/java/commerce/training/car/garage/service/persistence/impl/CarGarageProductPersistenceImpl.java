...
public class CarGarageProductPersistenceImpl
	...
	public void cacheResult(CarGarageProduct carGarageProduct) {
		entityCache.putResult(
			CarGarageProductModelImpl.ENTITY_CACHE_ENABLED,
	...
	public CarGarageProduct create(long carGarageProductId) {
		...
		carGarageProduct.setCompanyId(companyProvider.getCompanyId());
	...
	public CarGarageProduct remove(Serializable primaryKey)
		...
		catch (NoSuchCarGarageProductException nsee) {
			throw nsee;
		}
		catch (Exception e) {
			throw processException(e);
	...
	public CarGarageProduct updateImpl(CarGarageProduct carGarageProduct) {
		...
		if (!CarGarageProductModelImpl.COLUMN_BITMASK_ENABLED) {
			finderCache.clearCache(FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION);
		}
		else if (isNew) {
	 ...
	 */
	@Override
	public CarGarageProduct fetchByPrimaryKey(Serializable primaryKey) {
		...
		CarGarageProduct carGarageProduct = (CarGarageProduct)serializable;
		...
		if (carGarageProduct == null) {
			...
			try {
				...
				if (carGarageProduct != null) {
					...
					entityCache.putResult(
						CarGarageProductModelImpl.ENTITY_CACHE_ENABLED,
						CarGarageProductImpl.class, primaryKey, nullModel);
				}
			}
			catch (Exception e) {
				entityCache.removeResult(
	...
	@Override
	public Map<Serializable, CarGarageProduct> fetchByPrimaryKeys(
		...
		Map<Serializable, CarGarageProduct> map =
			new HashMap<Serializable, CarGarageProduct>();
		...
		if (primaryKeys.size() == 1) {
			...
			if (carGarageProduct != null) {
				map.put(primaryKey, carGarageProduct);
			}
		...
		for (Serializable primaryKey : primaryKeys) {
			...
			if (serializable != nullModel) {
				if (serializable == null) {
					...
					map.put(primaryKey, (CarGarageProduct)serializable);
				}
			}
		}
		...
		query.append(_SQL_SELECT_CARGARAGEPRODUCT_WHERE_PKS_IN);
		...
		try {
			...
			for (CarGarageProduct carGarageProduct :
					(List<CarGarageProduct>)q.list()) {

				map.put(carGarageProduct.getPrimaryKeyObj(), carGarageProduct);

				cacheResult(carGarageProduct);

				uncachedPrimaryKeys.remove(carGarageProduct.getPrimaryKeyObj());
			}
	...
	public void afterPropertiesSet() {
		_finderPathWithPaginationFindAll = new FinderPath(
			CarGarageProductModelImpl.ENTITY_CACHE_ENABLED,
			CarGarageProductModelImpl.FINDER_CACHE_ENABLED,
			CarGarageProductImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
		...
		_finderPathCountAll = new FinderPath(
			CarGarageProductModelImpl.ENTITY_CACHE_ENABLED,
			CarGarageProductModelImpl.FINDER_CACHE_ENABLED, Long.class,
		...
		_finderPathFetchByUUID_G = new FinderPath(
			CarGarageProductModelImpl.ENTITY_CACHE_ENABLED,
			CarGarageProductModelImpl.FINDER_CACHE_ENABLED,
			CarGarageProductImpl.class, FINDER_CLASS_NAME_ENTITY,
			"fetchByUUID_G",
	...
	private static final String _SQL_SELECT_CARGARAGEPRODUCT_WHERE_PKS_IN =
		"SELECT carGarageProduct FROM CarGarageProduct carGarageProduct WHERE carGarageProductId IN (";
